...
<html lang="en">
    <head>
        ...
        <title>Documentos Programa</title>
    </head>
    <body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            ?>
                                ...
                                <li class="active"><a href="<?php echo $documentos?>">Documentos</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="Badge__header" style="height: 50px;">
                                    <h2 style="color:antiquewhite; text-align:center; margin-top:0; padding-top:4px">Documentos</h2>
                                </div>
        ...
        <script>$(document).ready(function() { $(".push_menu").click(function() {$(".wrapper").removelass("active");});});</script>
    </body>
</html>
