                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            ?>
                                ...
                                <li class="active"><a href="<?php echo $gastos?>">Gastos</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="Badge__header" style="height: 50px;">
                                    <h2 style="color:antiquewhite; text-align:center; margin-top:0; padding-top:4px">Gastos</h2>
                                </div>
