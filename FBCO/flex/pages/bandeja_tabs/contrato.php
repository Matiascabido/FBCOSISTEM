                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            ?>
                                ...
                                <li class="active"><a href="<?php echo $contrato?>">Contrato</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="Badge__header" style="height: 50px;">
                                    <h2 style="color:antiquewhite; text-align:center; margin-top:0; padding-top:4px">Contrato</h2>
                                </div>
                                    ...
                                    <form class="col-md-10 col-md-offset-2">
                                        <div class="form-row" style="margin-right: 30px; margin-top:30px;">
                                            <div class="form-group col-sm-12 col-md-2 ">
                                                <small>Plazo firma contrato </small>
                                                <input type="text" class="form-control" style="width: 100px; height:30px; text-align: center;"/>
                                            </div>
                                            <div class="form-group col-sm-12 col-md-2 ">
                                                <small>Plazo firma contrato </small>
                                                <select class="form-control" style="width: 150px; height:30px; text-align: center;"><option value="">Enviado por ATM</option></select>                                               
                                            </div>
                                            <div class="form-group col-sm-12 col-md-2">
                                                <small>Datos Exactos </small>
                                                <div class="checkbox"><input type="checkbox" name="estado" checked></div>
                                            </div>
                                            <div class="form-group col-sm-12 col-md-4" style="margin-top:10px">
