                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            ?>
                                ...
                                <li class="active"><a href="<?php echo $aprobacionGerencial?>">Aprobación Gerencial</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="Badge__header" style="height: 50px;">
                                    <h2 style="color:antiquewhite; text-align:center; margin-top:0; padding-top:4px">Aprobación Gerencial</h2>
                                </div>
                                <div class="Badge__section-info" >
                                    <form class="col-md-10 col-md-offset-1">
                                        <div class="form-row" style="margin-right: 30px; margin-top:20px;">
                                            <div class="form-group col-sm-12 col-md-4 ">
                                                ...
                                                <input type="text" class="form-control" style="width: 320px; height:30px; text-align: center;"/>
                                            </div>
                                    ...
                                    <div class="form-row" style="margin-top:30px; margin-right: 30px;">
                                        ...
                                        <div class="form-group col-sm-12 col-md-4">
                                        <button class="btn btn-secondary"style="width:200px">Simular Crédito</button>
                                        </div>
                                </div>
